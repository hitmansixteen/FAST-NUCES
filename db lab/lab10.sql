...
begin
	...
	begin
		begin transaction 
			insert Registration values (@semester, @rollno,@courseID,@section,@cgpa)
		commit transaction 
		print 'Enrolled!'
	end
	else
	begin
		rollback
		print 'Can only be enrolled in improvement courses!'
	end
end

exec q1 @semester='Spring2017',@rollno='1',@courseid=10,@section='A',@cgpa=2.2
